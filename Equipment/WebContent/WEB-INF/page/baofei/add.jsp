...
<html>
  ...
  <body>
    <div class="x-body">
        <form class="layui-form" method="POST" id="baofeiForm"  action="${ctx}/baofei/add">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="changshang" name="yuanyin" required="" lay-verify="required"
        ...
        layui.use(['form','layer'], function(){
          ...
          form.on('submit(add)', function(data){
            ...
            layer.alert("成功", {icon: 6},function () {
            	document.getElementById('baofeiForm').submit();
                // 获得frame索引
